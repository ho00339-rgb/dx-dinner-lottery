...
// 7~12월 매월 MIX 1회 + PEER 1회 = 12회차, 월 24자리.
// 쿼터: T2(휴식 티어)는 5회, 나머지는 6회 — 매월 "아직 휴식 안 한 T2" 1명이 휴식.
// 이 전제(총 25명, T2 정확히 6명, 밴드 12/8/5)가 깨지면 앱이 자동으로
// 레거시 추첨으로 폴백함 (app.js의 seasonPlanValid 참조).
// =============================================================
const SEASON = {
  id: '2026H2',
  label: '2026 하반기',
